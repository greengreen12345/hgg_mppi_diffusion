...
class Objective(object):
    ...
    def compute_cost(self, sim: wrapper):
        ...
        # print("get_motion_cost_1", get_motion_cost_1)
    ...
    def get_motion_cost_1(self, sim: wrapper):
        ...
        self.closest_dist_all[self.closest_dist_all < 0.8] = 1
        self.closest_dist_all[self.closest_dist_all > 0.8] = 0

        #return 1000 * self.closest_dist_all
        #return 200 * self.closest_dist_all
        return 190 * self.closest_dist_all

    # Calculate the position of the points of the obstacle
    def obs_positions(self, sim):
        ...
        for actor_name in actor_names:
            ...
            # Given parameters
            center = position[0, :2]  # Midpoint position, shape (2,)
            length = size[0]  # length
            width = size[1]  # width
            radius = size[2]/2

            # Convert radius to Tensor and make sure the device is consistent
