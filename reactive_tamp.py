...
class REACTIVE_TAMP:
    def __init__(self, cfg) -> None:
        ...
        nn_model.load_weights(
            '/home/my/Hindsight-Goal-Generation-master4/Hindsight-Goal-Generation-master/src/m3p2i_aip/planners/mlp_learn/models/' + fname,
            params)
        print("-----------------------------------2")
    ...
    def run_tamp(self, dof_state, root_state, explore_goal):
        ...
        self.task_planner.curr_goal = explore_goal
